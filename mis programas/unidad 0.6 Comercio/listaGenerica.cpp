...
void mostrarLista(Lista lista){
  ...
  using namespace std; cout <<"/ %s /" << info <<endl;
...
int buscarEnLista(Lista lista, int* pos, int dato){
    ...
    tamanio = obtenerTamanio(lista);//#ver x que no funca obtener tamaño
    ...
    //recorremos la lista
    for(int i=0; i<2; i++){// ##tamaño harcodeado

            if(01 == dato){// #ver como mierda castiar aca el int
